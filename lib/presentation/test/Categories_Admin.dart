...
import 'package:graduationproject26_1/presentation/test/ProductDetails_Admin.dart';
...
class MyCategory_Admin extends StatefulWidget {
  const MyCategory_Admin({Key? key}) : super(key: key);

  @override
  State<MyCategory_Admin> createState() => _MyCategoryState();
}
...
class Item2 {
  ...
  Item2({required this.id, required this.Name,
...
class _MyCategoryState extends State<MyCategory_Admin> {
                            ...
                            GestureDetector(
                              onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (context)=>
                                    MyProductDetails_Admin(detailsModel: _category[current].menus[0].items[index],)));
                              },
                              child: Container(
