...
class MyProductDetails_Home extends StatelessWidget {
  final Item detailsModel;

  const MyProductDetails_Home({Key? key, required this.detailsModel}) : super(key: key);
            ...
            Align(
              ...
              child: Container(
                  ...
                  child: Card(
                      ...
                      child: Center(child: Image.network(detailsModel.image)))),
            ),
            SizedBox(
              height: 10,
            ),
