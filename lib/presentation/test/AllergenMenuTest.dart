...
class AllergenMenuScreenTest extends StatefulWidget {

  Restaurant detailsModel;

  AllergenMenuScreenTest({Key? key,required this.detailsModel}) : super(key: key);
  ...
  @override
  State<AllergenMenuScreenTest> createState() => _AllergenMenuScreenTestState();
}

class _AllergenMenuScreenTestState extends State<AllergenMenuScreenTest> {
