...
class AllergenMenuScreenTest_Home_Admin extends StatefulWidget {

  Restaurant detailsModel;

  AllergenMenuScreenTest_Home_Admin({Key? key,required this.detailsModel}) : super(key: key);
  ...
  @override
  State<AllergenMenuScreenTest_Home_Admin> createState() => _AllergenMenuScreenTestState();
}

class _AllergenMenuScreenTestState extends State<AllergenMenuScreenTest_Home_Admin> {
