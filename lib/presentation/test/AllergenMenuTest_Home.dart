...
class AllergenMenuScreenTest_Home extends StatefulWidget {

  Restaurant detailsModel;

  AllergenMenuScreenTest_Home({Key? key,required this.detailsModel}) : super(key: key);
  ...
  @override
  State<AllergenMenuScreenTest_Home> createState() => _AllergenMenuScreenTestState();
}

class _AllergenMenuScreenTestState extends State<AllergenMenuScreenTest_Home> {
