...
class MyProductDetails_Admin extends StatelessWidget {
  final Item2 detailsModel;

  const MyProductDetails_Admin({Key? key, required this.detailsModel}) : super(key: key);
