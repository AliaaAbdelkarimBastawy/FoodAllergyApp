...
DatabaseReference ref= LanguageGlobal.isEnglish? FirebaseDatabase.instance.ref("Restaurants") : FirebaseDatabase.instance.ref("RestaurantsArabic");

class _MyRestaurantsState extends State<MyRestaurants> {
  List<Restaurant> _restaurants = [];
  List<Restaurant> _restaurants2 = [];
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Navigator.of(context)
                                        ...
                                        AllergenMenuScreenTest(detailsModel: items[index],)));
                                  },
                                  child: Container(
